...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Adaline87',
      password: 'nA9fwZtgV98HeuK',
      email: 'Ray73@yahoo.com',
      name: 'Clifton Schmidt',
      mobileNo: '602.361.9781 x252',
      userType: 688,
      resetPasswordLink: {},
      loginRetryLimit: 182,
      loginReactiveTime: '2022-11-08T19:59:49.901Z',
      id: '622881369d20b0107313d0ae'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Nya.Hand33',
        'password':'iqWhWUObmsnNnk_',
        'email':'Shanny89@gmail.com',
        'name':'Vicky Sipes',
        'mobileNo':'1-451-768-3251 x99394',
