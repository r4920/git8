...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Sydnie_Walsh',
      password: 'To4ZctKv8xc_EsM',
      email: 'Abel_Emard@yahoo.com',
      name: 'Jose Hilpert',
      mobileNo: '207.500.7579',
      userType: 968,
      resetPasswordLink: {},
      loginRetryLimit: 597,
      loginReactiveTime: '2022-08-31T21:35:09.004Z',
      id: '622881369d20b0107313d0d2'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Jayson51',
        'password':'kJYBHfeGlWCGWTu',
        'email':'Isai_Steuber81@gmail.com',
        'name':'Doug Gottlieb',
        'mobileNo':'415.335.4444 x96542',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Isai_Steuber81@gmail.com', });
